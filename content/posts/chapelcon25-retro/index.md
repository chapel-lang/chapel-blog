...
ChapelCon '25 is behind us, and another year of productive HPC programming lies ahead!
...
First, last year's attendees were extremely enthusiastic about last year's tutorial and coding days.
...
This year we used EasyChair to manage the submissions and reviewing, and experimented with a more free-form review process, allowing program committee members to review any and all submissions they'd like.
...
With an extra conference day, we also had more time on the program to invite speakers from the HPC community, adding two invited talks to the traditional lineup of a keynote address and a [State of the Project talk](https://youtu.be/TU8inpSS16w). 
...
[Our second invited talk](https://youtu.be/YuY4XmKxruE) was from LLNL and HPSF's Todd Gamblin on Spack, the open-source HPC package management software. The talk, detailing Spack's path to version 1.0 was full of advice for open-source projects looking to expand their reach. 
...
The main idea of SciML is combine our scientific models with data sources, enabling efficiency and accuracy at levels unavailable to either source alone.
...
While there are too many for me to cover here (I encourage you to check them all out [on YouTube](https://www.youtube.com/playlist?list=PLuqM5RJ2KYFgTmbn3PmOocfu5Sh2wEcAb)), I'd like to bring attention to some that were especially enjoyed by the community.
...
Implemented using Arache (an Arkouda/Chapel-based graph library), it provides up to 66x speedup compared to state-of-the-art methods, and processes graphs large enough to cause memory failures in other technologies. 
