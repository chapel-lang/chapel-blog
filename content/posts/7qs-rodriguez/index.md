...
Welcome to the first installment of our [7 Questions for Chapel
...
7qs-bader>}}), who served as Oliver's thesis advisor.
...
software by improving underlying distributed graph data structures and
building tools to facilitate hierarchical simulation models.
...
graph as a sparse matrix and automatically assign CSR, CSC, or COO
...
of the underlying runtime, message passing, etc.
...
intern with the Chapel team in the summer of 2024 and worked with them
...
build a language packed with features. After all, what other language
has dedicated, parallel, distributed sparse matrix data structures
with all your favorite layouts? I’ll wait.

---

We’d like to thank Oliver for participating in the [7 Questions for
Chapel Users]({{< relref "series/7-questions-for-chapel-users" >}})
series. If you have any questions Oliver, or comments on the series,
please direct them to the [discussion
